...
const models: TsoaRoute.Models = {
    "GetArea": {
        ...
        "properties": {
            ...
            "area_name": {"dataType":"string","required":true},
        },
    ...
    "Review": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"created_at":{"dataType":"datetime","required":true},"evaluation":{"dataType":"double","required":true},"review_content":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},"category_id":{"dataType":"double","required":true},"area_id":{"dataType":"double","required":true},"user_id":{"dataType":"double","required":true},"id":{"dataType":"double","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "GetAreaDetail": {
        "dataType": "refObject",
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/area/:id',
            ...
            function AreaController_GetAreaDetail(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/question',
            ...
            function QuestionController_GetRefineQuestion(request: any, response: any, next: any) {
            const args = {
                    queryAreaId: {"in":"query","name":"queryAreaId","dataType":"string"},
                    queryCategoryId: {"in":"query","name":"queryCategoryId","dataType":"string"},
            };
            ...
            try {
              ...
              const promise = controller.GetRefineQuestion.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/review/create',
            ...
            function ReviewController_PostReview(request: any, response: any, next: any) {
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"PostReviewBody"},
            };
